...
md"Otra vez tenenmos la función seno con ruido"
...
# ╔═╡ 0065bc71-6746-48fc-8868-4e75e40ea0c8
md"Creemos el modelo en el cual vamos a usar una capa RNN con 30 neuronas y una capa densa con una neurona de salida"

# ╔═╡ 4985985b-2277-4b0a-ad3c-a4174c302bd8
modelRNN = Chain(RNN(1 => 50,relu), LSTM(50,30), LSTM(30, 10), Dense(10 => 1,celu))

# ╔═╡ 03f7a5c4-f4ce-492a-aaef-7d587dfa4a1e
md"Además creamos la función loss para las secuencias"

# ╔═╡ 3602c8ba-c712-425c-b22e-204a733585a5
function loss(x, y)
    sum(mse(modelRNN(xi), yi) for (xi, yi) in zip(x, y))
  end

# ╔═╡ 22b6508e-13cd-4a84-828b-202793967d66
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "c1464138e2e9b75d5e18d87ef906b6647b1754ac"
